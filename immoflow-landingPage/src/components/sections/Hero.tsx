...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    text.split(" ").forEach((word) => {
      ...
      outer.className = "inline-block mr-[0.3em] overflow-hidden";
      ...
      headingRef.current?.appendChild(outer);
    });
    ...
    const ctx = gsap.context(() => {
      ...
      entranceTl
        .fromTo(
          ...
          { opacity: 1, y: 0, scale: 1, duration: 1, delay: 0.45 }
        )
        .fromTo(
          words,
          { y: "110%", rotateX: -10 },
      ...
      if (!shouldReduceMotion) {
        ...
        scrollTl
          ...
          .fromTo(
            ...
            { y: "58vh", scale: window.innerWidth < 768 ? 0.9 : 1.03 },
            { y: "-42vh", scale: window.innerWidth < 768 ? 0.98 : 1.14, ease: "none" },
            0
          );
      }
    }, containerRef);
    ...
    return () => ctx.revert();
  }, [shouldReduceMotion, t.hero.title]);
  ...
  return (
    ...
    >
      ...
      <div
        ref={foregroundRef}
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-[4%] z-20 h-[92%] w-full will-change-transform md:inset-0 md:h-[130%] md:-top-[15%]"
      >
        <Image
      ...
      <div
        ...
        className="relative z-10 container mx-auto flex h-full flex-col items-center justify-center px-6 pb-24 pt-28 text-center text-white sm:pb-16"
      >
        <div ref={badgeRef}>
        ...
        <h1
          ref={headingRef}
          className="mb-8 max-w-5xl text-5xl font-medium leading-[1.05] tracking-tight sm:text-6xl md:text-7xl lg:text-8xl xl:text-[6.3rem]"
        >
          {t.hero.title}
        </h1>
        ...
        <p
          ref={subtextRef}
          className="mb-12 max-w-2xl text-base leading-relaxed text-white/78 md:text-lg"
        >
          {t.hero.description}
        </p>
