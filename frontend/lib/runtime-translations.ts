...
const fr: PhraseMap = {
  ...
  "available": "disponible",
  "Reservation in progress": "Reservation en cours",
  "Reserved": "Reserve",
  "reserve": "reserve",
  "en_cours_reservation": "reservation en cours",
  ...
  "listed": "publie",
  "Latitude:": "Latitude :",
  "Loading location data...": "Chargement des donnees de localisation...",
  "Loading map...": "Chargement de la carte...",
  "Location": "Localisation",
  "Location search failed.": "La recherche de localisation a echoue.",
  "Location service is temporarily unavailable.": "Le service de localisation est temporairement indisponible.",
  "Locataire": "Locataire",
  "Log out": "Deconnexion",
  "Longitude:": "Longitude :",
  ...
  "Method": "Methode",
  "Could not access your current location.": "Impossible d'acceder a votre position actuelle.",
  "Enter at least 3 characters.": "Saisissez au moins 3 caracteres.",
  "Geolocation is not supported in this browser.": "La geolocalisation n'est pas prise en charge par ce navigateur.",
  ...
  "No matching location found.": "Aucune localisation correspondante trouvee.",
  ...
  "Property status": "Statut du bien",
  ...
  "Search address or city": "Rechercher une adresse ou une ville",
...
const ar: PhraseMap = {
  ...
  "Available": "متاح",
  "available": "متاح",
  "Reservation in progress": "الحجز جار",
  "Reserved": "محجوز",
  "reserve": "محجوز",
  "en_cours_reservation": "الحجز جار",
  "disponible": "متاح",
  ...
  "listed": "منشور",
  "Latitude:": "خط العرض:",
  "Loading location data...": "جار تحميل بيانات الموقع...",
  "Loading map...": "جار تحميل الخريطة...",
  "Location": "الموقع",
  "Location search failed.": "فشل البحث عن الموقع.",
  "Location service is temporarily unavailable.": "خدمة الموقع غير متاحة مؤقتا.",
  "Locataire": "مكتري",
  ...
  "Method": "الطريقة",
  "Could not access your current location.": "تعذر الوصول إلى موقعك الحالي.",
  "Enter at least 3 characters.": "أدخل 3 أحرف على الأقل.",
  "Geolocation is not supported in this browser.": "الموقع الجغرافي غير مدعوم في هذا المتصفح.",
  ...
  "No matching location found.": "لم يتم العثور على موقع مطابق.",
  ...
  "Search address or city": "البحث عن عنوان أو مدينة",
  ...
  "Use current": "استخدم الموقع الحالي",
  "User": "مستخدم",
